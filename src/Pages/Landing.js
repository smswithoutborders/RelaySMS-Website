			...
			<Container dir={isRTL ? "rtl" : "ltr"}>
				<Row>
					<Col lg={8} md={6} sm={12} xs={12} className="hero-text-container ">
						...
						{/* ======================================= Buttons ============================================= */}
						<div className="d-block d-md-flex text-center text-md-start">
							<Button
								href="https://play.google.com/store/apps/details?id=com.afkanerd.sw0b"
								target="_blank"
								className="market-btn mb-3 mb-md-0 d-flex align-items-center"
								size="lg"
								style={{
							...
							>
								<div className="d-flex align-items-center w-100 justify-content-center">
									...
									<div className="text-start">
										<span className="market-button-subtitle">Download</span>
										<br />
